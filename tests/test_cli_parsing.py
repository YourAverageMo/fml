...
def test_main_with_query_and_default_model(
    mock_sys_argv,
    mock_sys_exit,
...
def test_main_with_query_and_specified_model(
    mock_sys_argv,
    mock_sys_exit,
    mock_initialize_ai_service,
    mock_output_formatter,
...
def test_main_with_multi_word_query(
    mock_sys_argv,
    mock_sys_exit,
    mock_initialize_ai_service,
    mock_output_formatter,
...
def test_main_handles_ai_service_runtime_error(
    mock_sys_argv, mock_sys_exit, mock_initialize_ai_service, capsys
):
    """
...
def test_main_handles_ai_service_value_error(
    mock_sys_argv, mock_sys_exit, mock_initialize_ai_service, capsys
):
    """
