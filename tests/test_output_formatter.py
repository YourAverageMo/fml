...
def test_format_response_no_flags(output_formatter):
    ...
    """
    ai_response = AICommandResponse(
        explanation="Displays current working directory.",
        flags=[],
        command="pwd"
    )
    expected_output = (
...
def test_format_response_empty_command(output_formatter):
    ...
    """
    flags = [
        Flag(flag="--version", description="Show version information")
    ]
    ai_response = AICommandResponse(
...
def test_format_response_empty_explanation(output_formatter):
    ...
    """
    flags = [
        Flag(flag="-v", description="Verbose output")
    ]
    ai_response = AICommandResponse(
        explanation="",
        flags=flags,
